...
/**
 * Created by zhengbinMac on 2017/4/28.
 */
public class QrCodeUtil {

    /**
     * 生成含有特定内容的二维码图片，并保存至指定的文件目录
     * @param imgPath
     * @param content
     * @return
     */
    public static boolean createQrcodeImage(String imgPath, String content) {
        BufferedImage qrcodeBufferedImage = qrcodeImage(content);
        writeImage(qrcodeBufferedImage, imgPath);
        return false;
    }
     ...
     * @return        图像数据缓存区
     */
    private static BufferedImage qrcodeImage(String content) {
        // 二维码宽度
        int width = 140;
        // 二维码高度
        int height = 140;
     ...
     * @param imgPath       图片路径
     */
    private static boolean writeImage(BufferedImage bufferedImage, String imgPath) {
        // 生成二维码的图片
